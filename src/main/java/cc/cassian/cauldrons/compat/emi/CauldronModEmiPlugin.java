...
public class CauldronModEmiPlugin implements EmiPlugin {
    ...
    public static final EmiRecipeCategory ALCHEMY_CATEGORY
            = new EmiRecipeCategory(CauldronMod.of("alchemy"), CAULDRON_WORKSTATION);
    ...
    public static final Map<ResourceLocation, EmiStack> OVERRIDES = Map.of(
            ...
            CauldronMod.of("honey"), EmiStack.of(CauldronModItems.HONEY_CONTENTS)
    );
    ...
    static Pair<EmiStack, EmiStack> getResultForDisplay(CauldronContents resultPotion) {
        if (resultPotion.potion().isPresent()) {
            ...
            return new Pair<>(EmiStack.of(PotionContents.createItemStack(Items.POTION, potion)), EmiStack.of(PotionContents.createItemStack(CauldronModItems.CAULDRON_CONTENTS, potion)));
    ...
    public void register(EmiRegistry registry) {
        ...
        // brewing
         ...
         for (RecipeHolder<BrewingRecipe> recipe : manager.getAllRecipesFor(CauldronModRecipes.BREWING)) {
             registry.addRecipe(new BrewingEmiRecipe(recipe, access));
         }
        // // dipping
         registry.addCategory(ALCHEMY_CATEGORY);
         registry.addWorkstation(ALCHEMY_CATEGORY, CAULDRON_WORKSTATION);
         for (RecipeHolder<AlchemyRecipe> recipe : manager.getAllRecipesFor(CauldronModRecipes.ALCHEMY)) {
             registry.addRecipe(new AlchemyEmiRecipe(recipe, access));
         }
